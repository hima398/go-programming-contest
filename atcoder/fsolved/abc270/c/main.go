...
func solve(n, x, y int, u, v []int) []int {
	e := make([][]int, n)
	m := n - 1
	for i := 0; i < m; i++ {
	...
	var a1 []int
	var dfs1 func(cur, par, to int) bool
	dfs1 = func(cur, par, to int) bool {
		if cur == to {
			a1 = append(a1, cur+1)
			return true
		}
	...
	var a2 []int
	var dfs2 func(cur, par, to int) bool
	dfs2 = func(cur, par, to int) bool {
		if cur == to {
			a2 = append(a2, cur+1)
			return true
		}
