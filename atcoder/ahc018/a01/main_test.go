...
func (t testJudge) output(y, x, p int) {
...
func Test_solveGreedy(t *testing.T) {
	t.Skip()
	...
	for i, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			res, err := solveGreedy(tt.args.n, tt.args.w, tt.args.k, tt.args.s, tt.args.a, tt.args.b, tt.args.c, tt.args.d)
			if err != nil {
				t.Errorf(err.Error())
...
func Test_solve01(t *testing.T) {
	...
	for i, tt := range tests {
		h = js[i]
		t.Run(tt.name, func(t *testing.T) {
			res, err := solve01(tt.args.n, tt.args.w, tt.args.k, tt.args.s, tt.args.a, tt.args.b, tt.args.c, tt.args.d)
			if err != nil {
				t.Errorf(err.Error())
				//fmt.Println(err.Error())
			}
